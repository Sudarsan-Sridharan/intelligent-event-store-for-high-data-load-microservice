...
@Entity
@javax.persistence.Table(name = "line_items")
public class LineItem extends BaseUUIDEntity implements IProduct {
    ...
    public LineItem(String title, float price, int amount, String cartUuid, float tax, String productUuid) {
        this.title = title;
        this.price = price;
        this.amount = amount;
